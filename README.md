...
![CrystalGF](https://github.com/chachapro/CrystalGF/blob/main/assets/CrystalGF.png))
...
pip install -r requirements.txt # if it fails, add the -i https://pypi.tuna.tsinghua.edu.cn/simple or -i https://mirrors.huaweicloud.com/repository/pypi/simple
```
