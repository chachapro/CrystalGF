...
from crystalgfh.common.constants import CompScalerMeans, CompScalerStds
from crystalgfh.common.data_utils import StandardScaler, chemical_symbols
from crystalgfh.pl_data.dataset import TensorCrystDataset
from crystalgfh.pl_data.datamodule import worker_init_fn
...
def get_model_path(eval_model_name):
    import crystalgfh
    model_path = (
        Path(crystalgfh.__file__).parent / 'prop_models' / eval_model_name)
    return model_path
