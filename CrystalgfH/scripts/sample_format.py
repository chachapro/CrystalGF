...
import torch
from pymatgen.io.cif import CifWriter
from sample_api import construct_dataset_from_json_format, construct_dataset_from_syminfo, generate_structures_from_dataset, diffusion, get_pymatgen
import os
import pandas as pd
...
def main(args):
    ...
    if args.json_file != '':
        dataset = construct_dataset_from_json_format(args.json_file)
